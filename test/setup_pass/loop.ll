; RUN: %opt %loadlibs -mi-config=splay -mi-imechanism=dummy -meminstrument -mi-mode=setup -S %s > %t.log
...
; RUN: grep -e "de\(clare\|fine\) .* @__memsafe_dummy_get_upper_bound" %t.log
