...
// CHECK: Create bounds for: @y
// CHECK-NEXT: Base: @y
// CHECK-NEXT: Bound: i32* getelementptr inbounds (i32, i32* @y, i32 1)

// CHECK: Create gep for @p
// CHECK-NEXT: Indices: i32 0 i32 0 i32 0

// CHECK: Create bounds for: @x
// CHECK-NEXT: Base: @x
// CHECK-NEXT: Bound: i32* getelementptr inbounds (i32, i32* @x, i32 1)
